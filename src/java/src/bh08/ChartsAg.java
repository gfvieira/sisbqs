...
public class ChartsAg extends HttpServlet {
    ...
    protected void doGet(
        ...
        consumo1 = daoengenharia.buscaAno(year--, 2);
        consumo2 = daoengenharia.buscaAno(year--, 2);
        consumo3 = daoengenharia.buscaAno(year--, 2);
        consumo4 = daoengenharia.buscaAno(year--, 2);

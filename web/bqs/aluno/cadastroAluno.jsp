                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h3 class="centered"><i class="fa fa-angle-double-right"></i><b> Cadastro de Aluno</b></h3><br><br>
                                        <%
                                            if (temp != null) {
                                                if (temp.equals("NO")) {
                                        %>
                                <div class="alert alert-danger centered"><b>erro!</b> Aluno não cadastrado, ou já consta em nosso sistema!</div>
                                <%
                                } else {
                                %>
                                <div class="alert alert-success" centered><b>Sucesso!</b> Aluno Cadastrado!</div>      				
                                <%
                                        }
                                    }
                                %>
                                <form class="form-horizontal style-form" action="CadAluno.jsp" method="post">

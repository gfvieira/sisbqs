                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h3 class="centered"><i class="fa fa-angle-double-right"></i><b> Cadastro de Resultado</b></h3><br><br>
                                        <%
                                            if (temp != null) {
                                                if (temp.equals("NO")) {
                                        %>
                                <div class="alert alert-danger centered"><b>erro!</b> Resultado não cadastrado, Aluno ou Simulado não encontrado!</div>
                                <%
                                } else {
                                %>
                                <div class="alert alert-success" centered><b>Sucesso!</b> Resultado Cadastrado!</div>      				
                                <%
                                        }
                                    }
                                %>
                                <form class="form-horizontal style-form" action="CadResultado.jsp" method="post">
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Simulado:</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="simulado" required>
                                        </div>
                                        <label class="col-sm-1 col-sm-2 control-label">Aluno:</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="aluno" required>
                                        </div>
                                    </div>
                                    <%
                                        for (int i = 1; i <= 50; i++) {
                                    %>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Questão <%out.print(i);%>:</label>
                                        <div class="col-sm-2">
                                            <select class="form-control" size="1" name="questao<%out.print(i);%>" required>
                                                <option value="">Selecione!</option>
                                                <option value="1">Acertou</option>
                                                <option value="2">Errou</option>
                                                <option value="3">Duvida</option>
                                            </select>                                        
                                        </div>
                                        <label class="col-sm-2 col-sm-2 control-label">Questão <%out.print(++i);%>:</label>
                                        <div class="col-sm-2">
